defmodule SoferBe.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: SoferBe.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SoferBeWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
